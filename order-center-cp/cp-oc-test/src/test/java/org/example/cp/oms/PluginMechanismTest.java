...
public class PluginMechanismTest {
    ...
    public void dynamicLoadPlugins() throws Throwable {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            assertContains(
                ...
                // CustomModel，扩展属性机制
                "站点联系人号码：139100988343，保存到x2字段", "已经发送给MQ");
        }
        ...
        assertContains("KA 预占库存 GSM098", "KA的锁TTL大一些", "steps [basic, persist]");
    ...
    public void dynamicLoadPartnerWithoutSpring() throws Throwable {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            assertContains("Fresh里预分拣的结果：2", "我，Fresh，要发个MQ通知我的下游！", "RPC调用库存中心系统，返回值是OK",
